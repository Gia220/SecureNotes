...
import androidx.activity.result.ActivityResultLauncher; // Nuova importazione
import androidx.activity.result.contract.ActivityResultContracts; // Nuova importazione
